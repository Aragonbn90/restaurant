...
export class Config {
  ...
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'restaurant';
  ...
  'jhipster.mail.from' = 'restaurant@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'restaurant API';
  'jhipster.swagger.description' = 'restaurant API documentation';
  ...
  'eureka.instance.appname' = 'restaurant';
  'eureka.instance.instanceId' = 'restaurant:${random.value}';
